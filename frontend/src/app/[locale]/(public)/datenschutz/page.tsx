...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://nexflow.work/datenschutz",
    languages: {
      de: "https://nexflow.work/datenschutz",
          ...
          <div className="prose prose-slate max-w-none space-y-10">
            ...
            <div>
              ...
              <p className="text-graphite text-sm leading-relaxed">
                ...
                <strong>Nexflow Sp. z o.o.</strong> mit Sitz in Słubice,
                Polen (NIP/USt-IdNr.: PL5981632310, KRS: 0000496516),
            ...
            <div>
              ...
              <PolicyTable
                rows={[
                  {
                    zweck: "Bewerberauswahl und Personalvermittlung",
                    grundlage:
                      "Art. 6 Abs. 1 lit. b DSGVO — Vertragserfüllung; Art. 6 Abs. 1 lit. a DSGVO — Einwilligung der betroffenen Person",
                  },
                  {
                  ...
                  {
                    zweck: "Abwicklung und Abrechnung von Arbeitseinsätzen",
                    grundlage:
                      "Art. 6 Abs. 1 lit. b und lit. c DSGVO — Vertragserfüllung und rechtliche Verpflichtungen (Arbeits-, Steuer- und Sozialversicherungsrecht)",
                  },
                  {
                    zweck: "Direktmarketing und Analyse",
                    grundlage:
                      "Art. 6 Abs. 1 lit. f DSGVO — berechtigte Interessen des Verantwortlichen",
                  },
                  {
                    zweck: "Erfüllung von Compliance-Pflichten (DSGVO, AÜG, AUeG)",
                    grundlage:
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-graphite leading-relaxed space-y-1">
                ...
                <li>Dokumentendaten: Aufenthalts- und Arbeitserlaubnisse, A1-Bescheinigung (für nach DE entsandte Arbeitnehmer)</li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-graphite leading-relaxed space-y-2">
                <li>
                  <strong>Bewerber:</strong> 12 Monate ab Eingang der Bewerbung,
                  sofern keine längere Einwilligung erteilt wurde oder ein Beschäftigungsverhältnis begründet wird.
                </li>
                <li>
                  <strong>Beschäftigte:</strong> Während der gesamten Beschäftigungsdauer
                  und anschließend für die gesetzlich vorgeschriebenen Aufbewahrungsfristen
                  (i. d. R. 10 Jahre nach Ende des Beschäftigungsverhältnisses gemäß Steuer- und Sozialversicherungsrecht).
                </li>
                <li>
                  <strong>Kontaktanfragen:</strong> Bis zur abschließenden Bearbeitung
                  und für 12 Monate nach dem letzten Kontakt zu Nachweiszwecken.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-graphite text-sm leading-relaxed mt-3">
                Nexflow verkauft keine personenbezogenen Daten an Dritte. Jede Übermittlung in
                Drittländer außerhalb des EWR erfolgt auf der Grundlage geeigneter Garantien
                ...
                {[
                  {
                    ...
                    desc: "Sie können eine Kopie der Daten anfordern, die wir über Sie gespeichert haben.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: "Sie können die Löschung Ihrer Daten verlangen (\"Recht auf Vergessenwerden\"), sofern keine andere Rechtsgrundlage für die Verarbeitung besteht.",
                  },
                  {
                    title: "Recht auf Datenübertragbarkeit",
                    desc: "Sie können Ihre Daten in einem strukturierten, gängigen und maschinenlesbaren Format erhalten.",
                  },
                  {
                    title: "Recht auf Einschränkung der Verarbeitung",
                    desc: "Sie können in bestimmten Fällen die Einschränkung der Verarbeitung Ihrer Daten verlangen.",
                  },
                  {
                    title: "Widerspruchsrecht",
                    desc: "Sie können der Verarbeitung widersprechen, die auf berechtigten Interessen des Verantwortlichen beruht.",
                  },
                  {
                    title: "Widerruf der Einwilligung",
                    desc: "Beruht die Verarbeitung auf Ihrer Einwilligung, können Sie diese jederzeit ohne Auswirkung auf die Rechtmäßigkeit der bisherigen Verarbeitung widerrufen.",
                  },
                  {
                    title: "Beschwerderecht",
                    desc: "Sie haben das Recht, eine Beschwerde bei der zuständigen Aufsichtsbehörde einzureichen — dem Präsidenten des polnischen Datenschutzamts (UODO, ul. Stawki 2, 00-193 Warschau) oder der deutschen Datenschutzbehörde Ihres Bundeslandes.",
                  },
                ].map((r) => (
                  <div
                    key={r.title}
            ...
            <div>
              ...
              <p className="text-graphite text-sm leading-relaxed">
                Die Website nexflow.work kann technisch notwendige Cookies verwenden,
                die für den Betrieb erforderlich sind. Tracking-Cookies von Drittanbietern
                werden ohne Ihre vorherige Einwilligung nicht gesetzt. Weitere Informationen
            ...
            <div>
              ...
              <p className="text-graphite text-sm leading-relaxed">
                Nexflow behält sich das Recht vor, diese Datenschutzerklärung zu aktualisieren.
                Über wesentliche Änderungen informieren wir durch Aktualisierung des Datums
                am Anfang dieses Dokuments. Die weitere Nutzung unserer Dienste nach
                Veröffentlichung von Änderungen gilt als Zustimmung.
              </p>
            </div>
...
function PolicyTable({
  ...
  rows: { zweck: string; grundlage: string }[];
}) {
  return (
