      ...
      <section className="py-16 bg-cloud-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate max-w-none space-y-10">
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">1. Verantwortlicher</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">2. Zwecke und Rechtsgrundlagen der Verarbeitung</h2>
              <PolicyTable
                rows={[
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">3. Kategorien verarbeiteter Daten</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">4. Speicherdauer</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">5. Empfänger der Daten</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">6. Ihre Rechte</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">7. Cookies und Analyse</h2>
              <p className="text-graphite text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-nexflow-navy mb-3">8. Änderungen dieser Datenschutzerklärung</h2>
              <p className="text-graphite text-sm leading-relaxed">
