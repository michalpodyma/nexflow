    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-7 shadow-2xl">
              ...
              <h2 className="text-xl font-bold text-ink-inverse mb-1">Nummer hinterlassen — wir rufen zurück</h2>
      ...
      <section className="py-16 bg-surface-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-ink-inverse text-center mb-2">Aktuelle Stellen</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {ROLES.map((role) => (
              <div key={role.title} className="bg-white rounded-2xl p-6 border border-gray-100 transition-shadow">
                ...
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <span className="text-xs font-semibold bg-nexflow-cyan/10 text-ink-inverse px-2 py-1 rounded-full whitespace-nowrap shrink-0">{role.badge}</span>
                </div>
