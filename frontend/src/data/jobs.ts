...
export const jobs: JobListing[] = [
  ...
  {
    id: "wh-magazynier-katy-wrocl",
    slug: "pracownik-magazynowy-katy-wroclawskie",
    countries: ["PL"],
    category: "picker",
    shiftKind: "day",
    salaryTier: "entry",
    ...
    salaryUnit: "HOUR",
    pl: {
      title: "Pracownik magazynowy (magazynier)",
      location: "Kąty Wrocławskie",
      shiftType: "Zmiana 10-godzinna",
      payRange: "32 PLN/h brutto (studenci: 32 PLN/h netto)",
      summary:
        "Praca w magazynie w Kątach Wrocławskich. Zmiana 10-godzinna. Stawka 32 zł brutto/h — studenci otrzymują 32 zł netto/h (zwolnienie podatkowe). Premia frekwencyjna: 100 zł netto przy 100% obecności w miesiącu.",
      requirements: [
        "Gotowość do pracy na 10-godzinnych zmianach",
        "Sprawność fizyczna",
        "Brak przeciwwskazań do pracy fizycznej w magazynie",
        "Studenci (do 26 r.ż.): stawka 32 zł netto/h dzięki zwolnieniu z PIT",
      ],
      tag: "Magazyn",
    },
    de: {
      title: "Lagerarbeiter / Magazinmitarbeiter",
      location: "Kąty Wrocławskie",
      shiftType: "10-Stunden-Schicht",
      payRange: "32 PLN/Std. brutto (Studenten: 32 PLN/Std. netto)",
      summary:
        "Lagerarbeit in Kąty Wrocławskie. 10-Stunden-Schichten. Bruttolohn 32 PLN/Std. — Studenten erhalten 32 PLN/Std. netto (Steuerbefreiung bis 26 J.). Anwesenheitsbonus: 100 PLN netto bei 100 % Anwesenheit im Monat.",
      requirements: [
        "Bereitschaft zu 10-Stunden-Schichten",
        "Körperliche Belastbarkeit",
        "Keine Einschränkungen für körperliche Lagerarbeit",
        "Studenten (bis 26 J.): 32 PLN/Std. netto dank PIT-Befreiung",
      ],
      tag: "Lager",
    },
    nl: {
      ...
      location: "Kąty Wrocławskie",
      shiftType: "10-uur dienst",
      payRange: "32 PLN/u bruto (studenten: 32 PLN/u netto)",
      summary:
        "Magazijnwerk in Kąty Wrocławskie. Diensten van 10 uur. Brutoloon 32 PLN/u — studenten ontvangen 32 PLN/u netto (belastingvrijstelling t/m 26 jaar). Aanwezigheidsbonus: 100 PLN netto bij 100% aanwezigheid in de maand.",
      requirements: [
        "Bereidheid tot 10-uur diensten",
        "Lichamelijke fitheid",
        "Geen bezwaar tegen fysiek magazijnwerk",
        "Studenten (t/m 26 jaar): 32 PLN/u netto dankzij PIT-vrijstelling",
      ],
      tag: "Magazijn",
    },
